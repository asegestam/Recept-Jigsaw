---
title: Blog
description: The list of blog recipes for the site
pagination:
    collection: recipes
    perPage: 4
---
...
<nav class="flex text-base my-8">
    ...
    <a href="{{ $path }}" title="Go to Page {{ $pageNumber }}" class="bg-gray-200 hover:bg-gray-400 rounded mr-3 px-5 py-3 {{ $pagination->currentPage == $pageNumber ? 'text-blue-600' : 'text-blue-700' }}">{{ $pageNumber }}</a>
    @endforeach
